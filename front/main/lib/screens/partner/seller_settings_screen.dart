      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSettingSection(
            ...
            title: '상점 정보',
            items: [
              _buildSettingItem('상점 정보 수정', Icons.store_mall_directory),
              _buildSettingItem('영업 시간 설정', Icons.access_time),
              _buildSettingItem('상품 카테고리 관리', Icons.category),
            ],
          ),
          const SizedBox(height: 20),
          _buildSettingSection(
            ...
            title: '알림 설정',
            items: [
              _buildSettingItem('주문 알림', Icons.notifications_active),
