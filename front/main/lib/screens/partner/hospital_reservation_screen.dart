...
/// 병원 예약 상담 화면
class HospitalReservationScreen extends StatefulWidget {
  const HospitalReservationScreen({super.key});

  @override
  State<HospitalReservationScreen> createState() =>
      _HospitalReservationScreenState();
}

class _HospitalReservationScreenState extends State<HospitalReservationScreen> {
  ...
  void _setupFCMListeners() {
    ...
    _fcmService.onMessageOpenedApp = (data) {
      print('🔔 [Hospital Reservation] 알림 클릭: $data');
