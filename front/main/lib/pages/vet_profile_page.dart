...
class _VetProfilePageState extends State<VetProfilePage> {
  ...
  Future<void> _loadReviews() async {
    try {
      ...
      print('📋 리뷰 로딩 시작 - Partner ID: $partnerId, Partner Name: ${widget.vet.name}');
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Icon(Icons.location_on, color: Color(0xFF4FC59E), size: 20),
                      const SizedBox(width: 4),
                      Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 12,
                    runSpacing: 12,
                    children: widget.vet.specialties.map((specialty) {
                      return Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 16,
                          vertical: 10,
            ...
            // 영업 시간
            if (widget.vet.workingStartHours != null && widget.vet.workingEndHours != null)
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          // 근무 요일
                          if (widget.vet.workingDays.isNotEmpty) ...[
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Icon(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Wrap(
                                        spacing: 6,
                                        runSpacing: 6,
                                        children: widget.vet.workingDays.map((day) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: widget.vet.availableTimes.map((time) {
                        return Container(
                          padding: const EdgeInsets.symmetric(
                            horizontal: 12,
                            vertical: 8,
                      ...
                      onPressed: widget.vet.isOpen
                          ? () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => ReservationRequestPage(vet: widget.vet),
                                ),
                              );
                            }
                          : null,
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => SimpleConsultationPage(partner: widget.vet),
                          ),
                        );
                      },
